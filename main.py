...
bot = Client("bot",    
   bot_token="7345439554:AAE7Q4sm73YNtGBDo3zFm0RDK8YIOoJn93Q",    
   api_id= 27149841,    
   api_hash= "109c63a1971283c71bc228bca5a63c6d"
)

@bot.on_message(filters.command(["start"]))    
async def account_login(bot: Client, m: Message):    
    editable = await m.reply_text("**👋 ʜᴇʟʟᴏ!\n\n🌟ɪ ᴀᴍ ᴛxᴛ ꜰɪʟᴇ ᴅᴏᴡʟᴏᴀᴅᴇʀ ʙᴏᴛ** \n\n<pre>💗 ᴘᴏᴡᴇʀᴇᴅ ʙʏ : @TGJokerX</pre>\n-═════━‧₊˚❀༉‧₊˚.━═════-") 
    ...
    try:    
        for i in range(count - 1, len(links)):
            ...
            try:
                ...
                cc = f'**╭━━━━━━━━━━━╮\n💫 𝐅ɪʟᴇ 𝐈𝐃:{str(count).zfill(3)}\n╰━━━━━━━━━━━╯\n**\n**📁𝐓ɪᴛʟᴇ :** {name1}({res})TGJokerX.mp4\n\n**📚𝐂ᴏᴜʀꜱᴇ : {b_name}**\n\n**📥𝖣𝗈𝗐𝗇𝗅𝗈𝖺𝖽𝖾𝖽 𝖡𝗒 : {MR}**\n\n'    
                ccyt = f'**╭━━━━━━━━━━━╮\n💫 𝐅ɪʟᴇ 𝐈𝐃:{str(count).zfill(3)}\n╰━━━━━━━━━━━╯\n**\n**📁𝐓ɪᴛʟᴇ :** {name1}({res})TGJokerX.mp4\n\n**🔗URL : ** {url}\n\n**📚𝐂ᴏᴜʀꜱᴇ : {b_name} **\n\n**📥𝖣𝗈𝗐𝗇𝗅𝗈𝖺𝖽𝖾𝖽 𝖡𝗒 : {MR}**\n\n'
                cc1 = f'**╭━━━━━━━━━━━╮\n💫 𝐅ɪʟᴇ 𝐈𝐃:{str(count).zfill(3)}\n╰━━━━━━━━━━━╯\n**\n**📁𝐓ɪᴛʟᴇ :** {name1}TGJokerX.pdf \n\n**📚𝐂ᴏᴜʀꜱᴇ : {b_name} **\n\n**📥𝖣𝗈𝗐𝗇𝗅𝗈𝖺𝖽𝖾𝖽 𝖡𝗒 : {MR}**\n'    
                if "drive" in url:    
                    try:    
